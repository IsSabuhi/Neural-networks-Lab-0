...
class Window:
    def __init__(self, width, height, title="MyWindow", icon=r"resources/images.ico"):
        ...
        self.penSize_slider = Scale(self.left_frame, from_=1, to=10, orient=HORIZONTAL)
    ...
    def draw_widgets(self):
        ...
        self.left_frame.pack(anchor=W, ipadx=20, pady=5, fill=Y, side=LEFT)
        self.right_frame.pack(anchor=E, ipadx=30, pady=30, fill=Y, side=LEFT)
        self.lbl0.pack(side=TOP)
        self.penSize_slider.pack(side=TOP)
    ...
    def paint(self, event):
        ...
        self.cv.create_oval(x1, y1, x2, y2, fill="black", width=self.penSize_slider.get())
        self.draw.line([x1, y1, x2, y2], fill="black", width=self.penSize_slider.get())
